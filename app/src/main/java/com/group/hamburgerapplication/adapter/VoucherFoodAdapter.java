...
public class VoucherFoodAdapter extends RecyclerView.Adapter<VoucherFoodAdapter.VoucherFoodViewHolder> {
    private final List<Voucher> listVouchers;
    public VoucherFoodAdapter(List<Voucher> listProducts) {
    ...
    public VoucherFoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_voucher_product,parent,false);
    ...
    public void onBindViewHolder(@NonNull VoucherFoodViewHolder holder, int position) {
        ...
        holder.txt_title.setText(voucher.getTitle());
    }
    ...
    public static class VoucherFoodViewHolder extends RecyclerView.ViewHolder{
        private TextView txt_date ,txt_description ,txt_title;
        public VoucherFoodViewHolder(@NonNull View itemView) {
            super(itemView);
            txt_date = itemView.findViewById(R.id.txt_date_product);
            txt_description=itemView.findViewById(R.id.txt_description_product);
